...
namespace Sinistar.UiControler.UIElements
{
    class UISpriteImage : UIElement
    {
        ...
        public UISpriteImage(double sx, double sy, int ox, int oy, Texture2D texture) : base(sx, sy, ox, oy)
        {
        ...
        public override void draw(SpriteBatch spriteBatch, double rotOx, double rotOy, float zIndex, int x, int y)
        {
            spriteBatch.Draw(texture, 
                new Rectangle((int)(x +sizeX * anchorPointX), (int)(y+sizeY*anchorPointY), sizeX, sizeY), 
                sourceSize, 
                color, 
                rotation, 
